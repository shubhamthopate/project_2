...
using CIC_EP.MultiTenancy.HostDashboard;
...
namespace CIC_EP.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(CIC_EPDbContext context, SubscriptionPayment subscriptionPayment)
        {
