...
using CIC_EP.Migrations.Seed.Host;
...
namespace CIC_EP.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : CIC_EPAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<CIC_EPDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{CIC_EPConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{CIC_EPConsts.ConnectionStringName}", constring);
        }
