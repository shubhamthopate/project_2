...
using CIC_EP.DemoUiComponents.Dto;

namespace CIC_EP.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : CIC_EPAppServiceBase, IDemoUiComponentsAppService
    {
