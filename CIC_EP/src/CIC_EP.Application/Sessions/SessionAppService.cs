...
{
    public class SessionAppService : CIC_EPAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = CIC_EPConsts.Currency,
                    CurrencySign = CIC_EPConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = CIC_EPConsts.AllowTenantsToChangeEmailSettings,
