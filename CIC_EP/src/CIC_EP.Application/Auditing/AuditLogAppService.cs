...
using CIC_EP.Auditing.Exporting;
using CIC_EP.Authorization;
using CIC_EP.Authorization.Users;
using CIC_EP.Dto;
using CIC_EP.EntityHistory;
using EntityHistoryHelper = CIC_EP.EntityHistory.EntityHistoryHelper;

namespace CIC_EP.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : CIC_EPAppServiceBase, IAuditLogAppService
    {
