...
using CIC_EP.EntityDynamicParameterValues.Dto;

namespace CIC_EP.DynamicEntityParameters
{
    [Authorize(AppPermissions.Pages_Administration_EntityDynamicParameterValue)]
    public class EntityDynamicParameterValueAppService : CIC_EPAppServiceBase, IEntityDynamicParameterValueAppService
    {
