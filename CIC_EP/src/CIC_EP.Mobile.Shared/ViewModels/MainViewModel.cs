...
using CIC_EP.Services.Navigation;
...
using CIC_EP.Controls;
using CIC_EP.Dto;
using CIC_EP.Extensions;
using CIC_EP.Localization;
using CIC_EP.UI;
using CIC_EP.UI.Assets;
using CIC_EP.Views;
using DependencyResolver = CIC_EP.Core.Dependency.DependencyResolver;
...
namespace CIC_EP.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "CIC_EP";
