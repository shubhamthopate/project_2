...
using CIC_EP.Core.Base;
using CIC_EP.Core.Extensions;
using CIC_EP.Dto;
using CIC_EP.Types;

namespace CIC_EP.Queries
{
    public class OrganizationUnitQuery : CIC_EPQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
