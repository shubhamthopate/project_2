...
using CIC_EP.EntityFrameworkCore.Repositories;

namespace CIC_EP.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : CIC_EPRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<CIC_EPDbContext> dbContextProvider)
