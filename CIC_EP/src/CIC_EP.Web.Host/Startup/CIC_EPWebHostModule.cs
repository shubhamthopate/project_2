...
using CIC_EP.Web.Startup.ExternalLoginInfoProviders;

namespace CIC_EP.Web.Startup
{
    [DependsOn(
        typeof(CIC_EPWebCoreModule)
    )]
    public class CIC_EPWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CIC_EPWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CIC_EPWebHostModule).GetAssembly());
        }
