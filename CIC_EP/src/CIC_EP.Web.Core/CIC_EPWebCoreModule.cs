...
using CIC_EP.Web.Authentication.JwtBearer;
using CIC_EP.Web.Authentication.TwoFactor;
using CIC_EP.Web.Chat.SignalR;
using CIC_EP.Web.Configuration;
using CIC_EP.Web.DashboardCustomization;

namespace CIC_EP.Web
{
    [DependsOn(
        typeof(CIC_EPApplicationModule),
        typeof(CIC_EPEntityFrameworkCoreModule),
    ...
    public class CIC_EPWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CIC_EPWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(CIC_EPApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CIC_EPWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(CIC_EPWebCoreModule).Assembly);
        }
