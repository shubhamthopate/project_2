...
using CIC_EP.Authorization.Delegation;
using CIC_EP.Authorization.Ldap;
using CIC_EP.Authorization.Roles;
using CIC_EP.Authorization.Users;
using CIC_EP.Chat;
using CIC_EP.Configuration;
using CIC_EP.DashboardCustomization.Definitions;
using CIC_EP.Debugging;
using CIC_EP.DynamicEntityParameters;
using CIC_EP.Features;
using CIC_EP.Friendships;
using CIC_EP.Friendships.Cache;
using CIC_EP.Localization;
using CIC_EP.MultiTenancy;
using CIC_EP.Net.Emailing;
using CIC_EP.Notifications;
using CIC_EP.WebHooks;

namespace CIC_EP
{
    [DependsOn(
        typeof(CIC_EPCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class CIC_EPCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            CIC_EPLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = CIC_EPConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, CIC_EPMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<CIC_EPSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CIC_EPCoreModule).GetAssembly());
        }
