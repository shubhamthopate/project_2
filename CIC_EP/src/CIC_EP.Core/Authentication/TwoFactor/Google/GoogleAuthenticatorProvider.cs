...
namespace CIC_EP.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : CIC_EPServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("CIC_EP", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
