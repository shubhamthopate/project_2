...
{
    public class StripeGatewayManager : CIC_EPServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "CIC_EP";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + CIC_EPConsts.Currency;
        }
