...
namespace CIC_EP.Web.Public.Startup
{
    ...
    public class CIC_EPWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public CIC_EPWebFrontEndModule(IWebHostEnvironment env, CIC_EPEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CIC_EPWebFrontEndModule).GetAssembly());
        }
    }
}
