...
using CIC_EP.Url;
using CIC_EP.Web.Public.Startup;
using CIC_EP.Web.Session;

namespace CIC_EP.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : CIC_EPViewComponent
    {
